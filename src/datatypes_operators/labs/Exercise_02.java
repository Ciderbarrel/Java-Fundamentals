...
public class Exercise_02 {
    ...
    public static void main(String[] args) {
        ...
        // write code here
        int xIntWide = 10;
        double yDoubleWide = xIntWide;
        System.out.println("Value = " + yDoubleWide);

        double yDoubleNarrow = 10.5;
        int xIntNarrow = (int) yDoubleNarrow;
        System.out.println("Value = " + xIntNarrow);
